...
<p style="color:#555;font-size:15px;line-height:1.6;margin:0 0 28px;">Votre argent sera viré sur votre compte bancaire dès confirmation du paiement.</p>
<p style="color:#555;font-size:15px;line-height:1.6;margin:0 0 12px;font-weight:600;">Paiement par virement bancaire SEPA</p>
<p style="color:#555;font-size:15px;line-height:1.6;margin:0 0 28px;">Pour accepter le paiement de votre acheteur, vous devez confirmer et authentifier le paiement en attente.</p>
<p style="color:#555;font-size:15px;line-height:1.6;margin:0 0 28px;">Pour finaliser la confirmation de paiement, cliquez sur le lien ci-dessous :</p>
